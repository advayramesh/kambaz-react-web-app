...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item> <Nav.Link href="https://github.com/advayramesh/kambaz-react-web-app/tree/a5" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
      <Nav.Item> <Nav.Link href="https://github.com/advayramesh/kambaz-node-server-app" target="_blank"> Server Code </Nav.Link> </Nav.Item>
    </Nav>
  );
}
